;diluOS --- The AM Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE diluOS_VER '1.0.0'	 ;OS version number
	%DEFINE diluOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	mov cx, 10001100b		; Colour: white text on light blue
	...
	os_init_msg		db '----- Welcome to dilu OS -----', 0
	os_version_msg		db 'Version ', diluOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', diluOS_VER, 0

	dialog_string_1		db 'Welcome to dilu Operating System', 0
